...
A multi-user drawing application with real-time synchronization using WebSockets and HTML5 Canvas.

## 🚀 Features

- **Real-time Drawing Synchronization**: See other users drawing in real-time
